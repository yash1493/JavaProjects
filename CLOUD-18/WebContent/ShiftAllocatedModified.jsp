		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="ShiftAllocation.jsp">SHIFT ALLOCATION</a></li>
		...
		<div class="container">
			...
			<div class="row text-center">
				<div class="col-md-8 col-md-offset-2">
					<h2>Employee ShiftAllocation Modified</h2>
			...
			<center>
				...
				<%
                   ...
                   Query query =session1.createQuery(" from ShiftAllocationPojo ");
				 ...
				 <table border="1"
					...
					<td height="50"width="100px"><%=EmpID%></td>
                        ...
                        <td><button><a href="ShiftAllocatedModifiedInput.jsp?EmpID=<%=EmpID%>">UPDATE</a></button></td>
					</tr>
