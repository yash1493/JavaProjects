...
<body>
	...
	<section class="for-full-back color-light " id="about">
		...
		<center><a href="HidemsginImage?EmpID=<%=EmpID%>&&EmployName=<%=EmployName%>&&Fullpath=<%=Fullpath%>&&filename=<%=filename%>"><img src="ImageGen//<%=filename %>" width="500px" height="500px"></a>  </center>
