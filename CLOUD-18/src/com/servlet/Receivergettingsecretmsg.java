...
public class Receivergettingsecretmsg extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String ImageFullpath = request.getParameter("ProjectDescription");
		...
		if (SecretKey.equals(Check_SecretKey))
		{
			...
			response.sendRedirect("ViewProjectAllocation.jsp");
		...
		}else 
		{
			...
			if (SecretKey.equals(Check1_SecretKey))
			{
				...
				Receivergettingsecretmsg msg7 = new Receivergettingsecretmsg();
