...
public class HidemsginImage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        JOptionPane pane = new JOptionPane("Hide Carefully !");  
        JDialog dialog = pane.createDialog("Alert");  
        dialog.setAlwaysOnTop(true);  
        dialog.show(); 
		

		String Msg1 = JOptionPane.showInputDialog("Enter Your Project Details");
	...
	public void stegnography(BufferedImage bimg, String msg,
		...
		if (msg.length() > 255) {
			...
			System.out.println(image);
				...
				String FullpathImage=realpath1+"\\CLOUD-18\\WebContent\\SecureCloud\\"+filename;

				File outputfile = new File(
						realpath1+"\\CLOUD-18\\WebContent\\SecureCloud\\"+filename);
				...
				response.sendRedirect("HidemsgSucess.jsp?EmpID="+EmpID+"&&EmployName="+EmployName+"&&Fullpath="+FullpathImage+"&&filename="+filename);
