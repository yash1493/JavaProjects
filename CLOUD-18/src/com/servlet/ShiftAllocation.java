...
/**
 * Servlet implementation class ShiftAllocation
 */
@WebServlet("/ShiftAllocation")
public class ShiftAllocation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("welcome to shift allocation page");
		...
		int i =in.shiftAllocation(sa);
		
		if(i >= 1)
		{
			System.out.println("process sucess");
			response.sendRedirect("ShiftAllocation.jsp");
		}
		else
		{
